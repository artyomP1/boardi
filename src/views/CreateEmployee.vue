  ...
  <div class="create-position">
    <section class="page-conatainer">
      ...
      <form v-if="formScheme.length > 0">
        ...
        <el-button :disabled="disabled" @click="createEmployee" type="primary"
          >Create</el-button
        >
      </form>
    </section>
...
export default {
  ...
  async created() {
    ...
    try {
      const res = await this.getEmployeeScheme();
  ...
  methods: {
    ...mapActions({
      getEmployeeScheme: "getEmployeeScheme",
    ...
    async createEmployee() {
      ...
      try {
        ...
        const res = await this.saveEmployee(data);
        this.$message({
